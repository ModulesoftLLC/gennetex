...
export default function App() {
  ...
  const nav=[...baseNav.slice(0,6),...(canSeeRevenue?[['revenue','Миний орлого',DollarSign] as const]:[]),...baseNav.slice(6)];
